...
### What should happen
 -
  ...
  # !todo: get these from Houston::Tickets.config.ticket_types
  ...
  initialize: (options)->
    ...
    @$el.find('#reset_ticket').click _.bind(@resetNewTicket, @)
    @$el.find('#create_ticket').click _.bind(@createNewTicket, @)
