class Ticket < ActiveRecord::Base
  ...
  validates :type, presence: true, inclusion: { in: Houston::Tickets.config.ticket_types, message: "\"%{value}\" is unknown. It must be #{Houston::Tickets.config.ticket_types.to_sentence(last_word_connector: ", or ")}" }
...
private
  ...
  def parse_ticket_description
    Houston::Tickets.config.parse_ticket_description(self)
  end
